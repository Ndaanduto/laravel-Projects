...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" type="text/css" href="usercss/css/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" type="text/css" href="usercss/css/style.css">
      <!-- Responsive-->
      <link rel="stylesheet" href="usercss/css/responsive.css">
      <!-- fevicon -->
      <link rel="icon" href="usercss/images/fevicon.png" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="usercss/css/jquery.mCustomScrollbar.min.css">
      <!-- Tweaks for older IEs-->
      <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css">
      <!-- fonts -->
      <link href="https://fonts.googleapis.com/css?family=Poppins:400,700|Righteous&display=swap" rel="stylesheet">
      <!-- owl stylesheets --> 
      <link rel="stylesheet" href="usercss/css/owl.carousel.min.css">
      <link rel="stylesheet" href="usercss/css/owl.theme.default.min.css">
   ...
   <body>
      ...
      <div class="header_section">
         <div class="header_main">
            ...
            <div class="container-fluid">
               <div class="logo"><a href="index.html"><img src="usercss/images/logo.png"></a></div>
               <div class="menu_main">
                  <ul>
      ...
      <div class="services_section layout_padding">
         <div class="container">
            ...
            <div class="services_section_2">
               <div class="row">
                  <div class="col-md-4">
                     <div><img src="usercss/images/img-1.png" class="services_img"></div>
                     <div class="btn_main"><a href="#">Rafting</a></div>
                  </div>
                  <div class="col-md-4">
                     <div><img src="usercss/images/img-2.png" class="services_img"></div>
                     <div class="btn_main active"><a href="#">Hiking</a></div>
                  </div>
                  <div class="col-md-4">
                     <div><img src="usercss/images/img-3.png" class="services_img"></div>
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-md-6 padding_right_0">
                  <div><img src="usercss/images/about-img.png" class="about_img"></div>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="blog_section layout_padding">
         <div class="container">
            ...
            <div class="play_icon_main">
               <div class="play_icon"><a href="#"><img src="usercss/images/play-icon.png"></a></div>
            </div>
         </div>
      </div>
      <!-- blog section end -->
                        ...
                        <div class="client_main">
                           ...
                           <div class="box_right">
                              <div class="client_taital_left">
                                 <div class="client_img"><img src="usercss/images/client-img.png"></div>
                                 <div class="quick_icon"><img src="usercss/images/quick-icon.png"></div>
                              </div>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="location_main">
               <div class="call_text"><img src="usercss/images/call-icon.png"></div>
               <div class="call_text"><a href="#">Call +01 1234567890</a></div>
               <div class="call_text"><img src="usercss/images/mail-icon.png"></div>
               <div class="call_text"><a href="#">demo@gmail.com</a></div>
            </div>
            <div class="social_icon">
               <ul>
                  <li><a href="#"><img src="usercss/images/fb-icon.png"></a></li>
                  <li><a href="#"><img src="usercss/images/twitter-icon.png"></a></li>
                  <li><a href="#"><img src="usercss/images/linkedin-icon.png"></a></li>
                  <li><a href="#"><img src="usercss/images/instagram-icon.png"></a></li>
               </ul>
            </div>
         </div>
      </div>
      ...
      <script src="usercss/js/popper.min.js"></script>
      <script src="usercss/js/bootstrap.bundle.min.js"></script>
      <script src="usercss/js/jquery-3.0.0.min.js"></script>
      <script src="usercss/js/plugin.js"></script>
      <!-- sidebar -->
      <script src="usercss/js/jquery.mCustomScrollbar.concat.min.js"></script>
      <script src="usercss/js/custom.js"></script>
      <!-- javascript --> 
      <script src="usercss/js/owl.carousel.js"></script>
